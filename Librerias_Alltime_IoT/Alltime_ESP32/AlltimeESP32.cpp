...
void ESP32_B::setup(const char* red , const char* pass, const char* key, const char* usuario, const char* pasw) {
...
void ESP32_B::enviarGPS(String outtopic)
{
  if (flag>=1) {
...
String ESP32_B::Leer(String var)
{
...
void ESP32_B::suscripcion(String suscripcion,byte salida)
{ delay(500);
  cont++;
...
void ESP32_B::Enviar(String data, String outtopic)
{
client.loop();
ArduinoOTA.handle();
...
void ESP32_B:: datosGPS() {
  ...
  Gps.begin(9600, SERIAL_8N1, pinrxx, pintxx);
...
void ESP32_B::Robot(String motor)
{
...
void ESP32_B::robot_pin(int pin)
{
 cont2++;
...
void ESP32_B::gp(int gpintx,int gpinrx)
{
